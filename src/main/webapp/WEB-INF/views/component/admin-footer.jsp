...
<script src="<c:url value="${base}/resources/js/lib/menubar/sidebar.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/preloader/pace.min.js"/> "></script>
...
<!--  Calender 2 -->
<script src="<c:url value="${base}/resources/js/lib/calendar-2/moment.latest.min.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/calendar-2/pignose.calendar.min.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/calendar-2/pignose.init.js"/> "></script>



<!-- JS Grid -->
<script src="<c:url value="${base}/resources/js/lib/jsgrid/db.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/jsgrid.core.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/jsgrid.load-indicator.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/jsgrid.load-strategies.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/jsgrid.sort-strategies.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/jsgrid.field.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/fields/jsgrid.field.text.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/fields/jsgrid.field.number.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/fields/jsgrid.field.select.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/jsgrid/fields/jsgrid.field.checkbox.js"/> "></script>
...
<script src="<c:url value="${base}/resources/js/lib/rangeSlider/moment.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/rangeSlider/moment-with-locales.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/rangeSlider/rangeslider.init.js"/> "></script>

<!-- Bar Rating-->
<script src="<c:url value="${base}/resources/js/lib/barRating/jquery.barrating.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/barRating/barRating.init.js"/> "></script>

<!-- jRate -->
<script src="<c:url value="${base}/resources/js/lib/rating1/jRate.min.js"/> "></script>
<script src="<c:url value="${base}/resources/js/lib/rating1/jRate.init.js"/> "></script>
